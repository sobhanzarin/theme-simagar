...
define( 'ESPACK', plugin_dir_path(__FILE__));
if (get_locale() == 'fa_IR' ) {

$text_domain = 'elementor-pro';
	$ESPACK_lang =  ESPACK . "/languages/elementor-pro-fa_IR.mo";
	$wordpress_lang = "/languages/plugins/elementor-pro-fa_IR.mo";
	unload_textdomain($text_domain);
	load_textdomain($text_domain, $ESPACK_lang );
}
...
$response = wp_remote_get( "http://elesite.ir/lib/{$parsed_args['body']['id']}.json", [ 'sslverify' => false, 'timeout' => 25 ] );
...
$myUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://esdownload.ir/json/elementorpro-343734653221mp.json',
